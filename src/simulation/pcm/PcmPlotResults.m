    ...
    for Mean = 0:1
        ...
        for iCV = 1
            ...
            for tr = 1:numel(M) - 2
                ...
                tmp1 = mat2cell(repmat(Models(tr).Cpts, numel(M) - 2, 1), ...
                                ones(numel(M) - 2, 1), ...
                                numel(Models(tr).Cpts));
                ...
                if iCV == 0
                    T = pcm_plotModelLikelihood(tmp{tr, sm}.Tgroup, M, ...
                                                'upperceil', tmp{tr, sm}.Tgroup.likelihood(:, end), ...
                                                'normalize', 0, ...
                                                'colors', colors, ...
                                                'style', 'bar', ...
                                                'varfcn', 'sem');
                else
                    T = pcm_plotModelLikelihood(tmp{tr, sm}.Tcross, M, ...
                                                'upperceil', tmp{tr, sm}.Tgroup.likelihood(:, end), ...
                                                'normalize', 0, ...
                                                'colors', colors, ...
                                                'style', 'bar', ...
            ...
            mtit(sprintf('PCM - %sCV - noise level=%i - %s', CV_suffix, sm, mean_suffix), ...
