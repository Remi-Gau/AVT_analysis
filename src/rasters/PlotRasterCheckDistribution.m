...
for iSub = 1 % :NbSub
    ...
    for iROI = 1 % :numel(ROI)
        ...
        for iCdt = 4 % 1:6
            ...
            h = figure('Name', [ROI(iROI).name ' - ' CondNames2Plot{iCdt}], ...
                       'Position', [100, 100, 1500, 1000], 'Color', ...
                       [1 1 1], 'Visible', 'on');
            ...
            axis('square');
            set(gca, 'tickdir', 'out', ...
                'xtick', 1:size(Profiles, 2), ...
                'xticklabel', 1:size(Profiles, 2), ...
                'ytick', 1:size(Profiles, 2), ...
                'yticklabel', size(Profiles, 2):-1:1, ...
            ...
            distributionPlot(NoiseToPlot, ...
                             'xValues', 1:size(Profiles, 2), ...
                             'color', 'k', ...
                             'distWidth', 0.8, ...
                             'showMM', 1, ...
                             'globalNorm', 2, ...
