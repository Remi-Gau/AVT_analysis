...
for iSub = 1:NbSub
    ...
    for iROI = 1:numel(ROI)
        ...
        for iCdt = 1:size(Cdt_ROI_lhs,2)
            ...
            tmp_stim = cat(3,tmpL,tmpR); clear tmpL tmpR Stim_Beta2Sel_lhs Stim_Beta2Sel_rhs
            
            tmpL = shiftdim(FeaturesTargetsL(:,:,Targ_Beta2Sel_lhs),1);
            tmpR = shiftdim(FeaturesTargetsR(:,:,Targ_Beta2Sel_rhs),1);
            tmp_target = cat(3,tmpL,tmpR); clear tmpL tmpR Targ_Beta2Sel_lhs Targ_Beta2Sel_rhs
