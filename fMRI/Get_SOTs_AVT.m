...
for SubjInd = 1:length(Subjects)
    ...
    for iFile = 1:length(LogFileList)
        ...
        S.sots{1} = SOT{1,1,iFile}/S.TR;
        S.sots{2} = SOT{1,2,iFile}/S.TR;
        S.sots{3} = SOT{2,1,iFile}/S.TR;
        S.sots{4} = SOT{2,2,iFile}/S.TR;
        S.sots{5} = SOT{3,1,iFile}/S.TR;
        S.sots{6} = SOT{3,2,iFile}/S.TR;
        S.sots{7} = [SOT{4,1,iFile} SOT{4,2,iFile}]/S.TR;

        S.Ns = ceil((S.Ns/S.TR))+5;
        ...
        axis([0 S.Ns 0 1.2])
        set(gca,'tickdir', 'out', 'xtick', 0:10:(S.Ns) ,...
            'xticklabel', (0:10:(S.Ns))*S.TR, ...
