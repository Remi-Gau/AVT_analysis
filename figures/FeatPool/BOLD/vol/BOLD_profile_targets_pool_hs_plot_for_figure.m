...
for NbLayers=6
    for WithQuad= 1
        for WithPerm = 0
            ...
            if WithQuad
                load(fullfile(ResultsDir, strcat('ResultsVolTargetsPoolQuadGLM_l-', num2str(NbLayers), '.mat')), 'AllSubjects_Data') %#ok<*UNRCH>
            else
                load(fullfile(ResultsDir, strcat('ResultsVolTargetsPoolNoQuadGLM_l-', num2str(NbLayers), '.mat')), 'AllSubjects_Data') %#ok<*UNRCH>
            end
            ...
            for iROI = 1:length(AllSubjects_Data)
                ...
                %% Left VS Right
                ToPlot.Name = [Name '-Targets-Ipsi-Contra'];
                ...
                ToPlot.Name = [Name '-Targets-SensModContrastsIpsi'];
                ...
                ToPlot.Name = [Name '-Targets-SensModContrastsContra'];
