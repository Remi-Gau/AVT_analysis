...
mkdir(Reg_dir, 'Cdt'); mkdir(fullfile(Reg_dir, 'Cdt', 'Subjects'));
mkdir(Reg_dir, 'Sens'); mkdir(fullfile(Reg_dir, 'Sens', 'Subjects'));
mkdir(Reg_dir, 'Side'); mkdir(fullfile(Reg_dir, 'Side', 'Subjects'));
Cor_dir = fullfile(StartDir, 'figures', 'Correlation');
mkdir(Cor_dir, 'Cdt'); mkdir(fullfile(Cor_dir, 'Cdt', 'Subjects'));
mkdir(Cor_dir, 'Sens'); mkdir(fullfile(Cor_dir, 'Sens', 'Subjects'));
mkdir(Cor_dir, 'Side'); mkdir(fullfile(Cor_dir, 'Side', 'Subjects'));
