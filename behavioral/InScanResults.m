...
for iSub = [1:NbSub] % for each subject
    ...
    for iSes = 1:NbSes % for each session
        ...
        for iRuns=1:length(TSV)
            ...
            tmp2 = strcmp(tmp,'AStimL'); NbAStimL = tmp{tmp2,2};
            tmp2 = strcmp(tmp,'VStimL'); NbVStimL = tmp{tmp2,2};
            tmp2 = strcmp(tmp,'TStimL'); NbTStimL = tmp{tmp2,2};
            tmp2 = strcmp(tmp,'ATargL'); NbATargL = tmp{tmp2,2};
            tmp2 = strcmp(tmp,'VTargL'); NbVTargL = tmp{tmp2,2};
            tmp2 = strcmp(tmp,'TTargL'); NbTTargL = tmp{tmp2,2};
            tmp2 = strcmp(tmp,'AStimR'); NbAStimR = tmp{tmp2,2};
            tmp2 = strcmp(tmp,'VStimR'); NbVStimR = tmp{tmp2,2};
            tmp2 = strcmp(tmp,'TStimR'); NbTStimR = tmp{tmp2,2};
            tmp2 = strcmp(tmp,'ATargR'); NbATargR = tmp{tmp2,2};
            tmp2 = strcmp(tmp,'VTargR'); NbVTargR = tmp{tmp2,2};
            tmp2 = strcmp(tmp,'TTargR'); NbTTargR = tmp{tmp2,2};
            ...
            tmp2 = strcmp(tmp,'Response'); NbResponses = tmp{tmp2,2};
