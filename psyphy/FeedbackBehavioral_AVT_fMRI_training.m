...
for SubjInd = 1:length(Subjects)
    ...
    LogFileList = dir(strcat('Logfile_Subject_', num2str(Subjects(SubjInd)), '_Run_31*.txt'));
    TrialListFileList = dir(strcat('Trial_List_Subject_', num2str(Subjects(SubjInd)), '_Run_31*.txt'));
    ...
    grid on
    axis([-1 5 0 100]);
    set(gca, 'ytick', 0:10:100, 'yticklabel', 0:10:100, 'xtick', 0:4, ...
    ...
    set(t, 'FontSize', 8)
    plot([5.5 5.5],[0 101],'k','LineWidth',2)
    xlabel('Run')
    grid on
