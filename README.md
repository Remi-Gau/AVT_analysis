...
- The manual coregistration function from [SPM-RG](https://github.com/Remi-Gau/SPM-RG)
- FSL
- SPM 12
- [MIPAV](https://mipav.cit.nih.gov/)
- [JIST and the CBS tools](https://www.nitrc.org/projects/cbs-tools/)
- cosmetic
...
**Processing the beta images: code/preprocess_betas/**
...
**Mapping the beta images on surfaces: code/cbs or sub-xx/code/cbs/**
...
Processed data are stored in “derivative” folder.
...
**SESSION**
**derivative/sub-xx/ses-x**
Functional data for each session (i.e day)
**derivative/sub-xx/ses-x/fmap**
- Field maps
- Voxel displacement maps (VDM) generated by SPM
 
**derivative/sub-xx/ses-x/func**
- Raw functional data for the runs of that session
- Preprocessed data (realign and unwarp, slice timing smoothed with default SPM prefixes)
- TSV files for stimulus onsets and responses (see BIDS)
